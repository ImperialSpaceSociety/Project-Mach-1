...
// MOD_type: 2    Rsymb(sps): 100    Fdev(Hz): 1000    RXBW(Hz): 150000    Manchester: 0    AFC_en: 0    Rsymb_error: 0.0    Chip-Version: 2    
// RF Freq.(MHz): 433    API_TC: 29    fhst: 250000    inputBW: 0    BERT: 0    RAW_dout: 0    D_source: 0    Hi_pfm_div: 1    
// 
// # RX IF frequency is  -500000 Hz
// # WB filter 2 (BW =  36.64 kHz);  NB-filter 2 (BW = 36.64 kHz)
// 
// Modulation index: 20
*/
...
*/
#define RF_MODEM_MOD_TYPE_12 0x11, 0x20, 0x0C, 0x00, 0x02, 0x00, 0x07, 0x00, 0x03, 0xE8, 0x01, 0xE8, 0x48, 0x00, 0x00, 0x00
...
*/
#define RF_MODEM_TX_RAMP_DELAY_8 0x11, 0x20, 0x08, 0x18, 0x01, 0x80, 0x08, 0x03, 0x80, 0x00, 0x38, 0x11
...
*/
#define RF_MODEM_AFC_GEAR_7 0x11, 0x20, 0x07, 0x2C, 0x04, 0x36, 0x80, 0x01, 0x58, 0x4D, 0x80
...
*/
#define RF_MODEM_AGC_WINDOW_SIZE_9 0x11, 0x20, 0x09, 0x38, 0x11, 0xB6, 0xB6, 0x00, 0x02, 0xFF, 0xFF, 0x00, 0x2B
...
*/
#define RF_MODEM_OOK_CNT1_8 0x11, 0x20, 0x08, 0x42, 0xA4, 0x02, 0xD6, 0x81, 0x00, 0xA2, 0x01, 0x80
...
*/
#define RF_FREQ_CONTROL_INTE_8 0x11, 0x40, 0x08, 0x00, 0x35, 0x09, 0x00, 0x00, 0x40, 0x00, 0x20, 0xFE
