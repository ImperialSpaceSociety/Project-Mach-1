...
/*
 * Rocket flight computer ground station
 * All packets received from the rocket flight computer will be received and 
 * printout will appear of location on the serial terminal.
 *
 * 
 */
