...
void loop()
{
  ...
  #define START_BYTE HIGH_BYTE
  #define STOP_BYTE LOW_BYTE

  #define OUR_CHAR START_BYTE,LOW_BYTE,HIGH_BYTE,HIGH_BYTE,LOW_BYTE,LOW_BYTE,HIGH_BYTE,HIGH_BYTE,LOW_BYTE,STOP_BYTE,
