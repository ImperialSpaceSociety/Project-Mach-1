 ...
 * 
 * This code will dump all the saved data from the spi flash chip on the flight computer. 
 * Open the serial monitor to see the data appear like a CSV file.
 * The fields of each line are the following:
 * 
 *   gps_unix_time, gps_millisecond, timestamp, longitude, latitude, altitude,temperature,pressure,
 *   h3lis_gyro[0], h3lis_gyro[1], h3lis_gyro[2], h3lis_accelerometer[0], h3lis_accelerometer[1], h3lis_accelerometer[2],
 *   lsm9d_gyro[0], lsm9d_gyro[1], lsm9d_gyro[2], lsm9d_accel[0], lsm9d_accel[1], lsm9d_accel[2],
 *   lsm9d_mag[0], lsm9d_mag[1], lsm9d_mag[2]
 * 
 */
#include <SPI.h>
