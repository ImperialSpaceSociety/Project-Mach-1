 ...
 * |       20   |        Unused       |      PA27     |        D20      | 
 * +------------+---------------------+---------------+-----------------+--------------------------------------------------------------------------------------------------------
 * |       21   |   Flash_SPI_MISO    |      PB00     |        D21      | Sercom5  SPI1
 * +------------+---------------------+---------------+-----------------+--------------------------------------------------------------------------------------------------------
 * |       22   |   Flash_SPI_NSEL    |      PB01     |        D22      | Sercom5  SPI1
 * +------------+---------------------+---------------+-----------------+--------------------------------------------------------------------------------------------------------
 * |       23   |   Flash_SPI_MOSI    |      PB02     |        D23      | Sercom5  SPI1
 * +------------+---------------------+---------------+-----------------+--------------------------------------------------------------------------------------------------------
 * |       24   |   Flash_SPI_SCLK    |      PB03     |        D24      | Sercom5  SPI1
 * +------------+---------------------+---------------+-----------------+--------------------------------------------------------------------------------------------------------
 * |       25   |       Unused        |      PA04     |        D25      | 
 * +------------+---------------------+---------------+-----------------+--------------------------------------------------------------------------------------------------------
 * |       26   |       Unused        |      PB05     |        D26      | 
 ...
 * |       31   |      RF_SDN         |      PB11     |        D31      | 
 * +------------+---------------------+---------------+-----------------+--------------------------------------------------------------------------------------------------------
 * |       32   |   RF_SPI_MOSI       |      PB12     |        D32      | Sercom4  SPI
 * +------------+---------------------+---------------+-----------------+--------------------------------------------------------------------------------------------------------
 * |       33   |   RF_SPI_SCLK       |      PB13     |        D33      | Sercom4  SPI
 * +------------+---------------------+---------------+-----------------+--------------------------------------------------------------------------------------------------------
 * |       34   |   RF_SPI_MISO       |      PB14     |        D34      | Sercom4  SPI
 * +------------+---------------------+---------------+-----------------+--------------------------------------------------------------------------------------------------------
 * |       35   |   RF_SPI_NSEL       |      PB15     |        D35      | Sercom4  SPI
 * +------------+---------------------+---------------+-----------------+--------------------------------------------------------------------------------------------------------
 * |       36   |       Unused        |      PB16     |        D36      | 
 * +------------+---------------------+---------------+-----------------+--------------------------------------------------------------------------------------------------------
 * |       37   |       MAG_RDY       |      PB17     |        D37      | 
...
{ 
  ...
  */
  ...
  { PORTA, 8,  PIO_SERCOM,     PIN_ATTR_DIGITAL,                                       No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE  }, // I2C Sercom0/PAD[0] SDA, D6
  { PORTA, 9,  PIO_SERCOM,     PIN_ATTR_DIGITAL,                                       No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE  }, // I2C Sercom0/PAD[1] SCL, D7
